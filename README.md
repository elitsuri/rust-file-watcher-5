...
> Rust File Watcher: File system watcher with Rust, Notify, event processing, and hooks
...
git clone https://github.com/elitsuri/rust-file-watcher
cd rust-file-watcher
